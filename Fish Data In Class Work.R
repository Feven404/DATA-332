...
df_fish <- read_csv('~/DATA 332/DATA for Fish/Fish.csv')
df_kelp_fronds <- read_excel('~/DATA 332/DATA for Fish/kelp_fronds.xlsx')

fish_garbaldi <- df_fish %>%
